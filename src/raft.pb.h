...
class AppendEntriesReply final :
 ...
 public:
  ...
  int32_t startfrom() const;
  void set_startfrom(int32_t value);
  private:
  int32_t _internal_startfrom() const;
  void _internal_set_startfrom(int32_t value);
  public:
...
class RequestVoteArgs final :
 ...
 public:
  ...
  int32_t candidatedid() const;
  void set_candidatedid(int32_t value);
  private:
  int32_t _internal_candidatedid() const;
  void _internal_set_candidatedid(int32_t value);
  public:
...
inline const ::Entry& AppendEntriesArgs::_internal_entries(int index) const {
...
inline ::Entry* AppendEntriesArgs::_internal_add_entries() {
  return entries_.Add();
}
inline ::Entry* AppendEntriesArgs::add_entries() {
  ::Entry* _add = _internal_add_entries();
...
inline bool AppendEntriesReply::_internal_conflict() const {
  return conflict_;
}
...
inline void AppendEntriesReply::_internal_set_conflict(bool value) {
...
inline int32_t AppendEntriesReply::_internal_startfrom() const {
  return startfrom_;
}
inline int32_t AppendEntriesReply::startfrom() const {
  // @@protoc_insertion_point(field_get:AppendEntriesReply.startFrom)
  return _internal_startfrom();
}
inline void AppendEntriesReply::_internal_set_startfrom(int32_t value) {
  
  startfrom_ = value;
}
inline void AppendEntriesReply::set_startfrom(int32_t value) {
  _internal_set_startfrom(value);
...
inline int32_t RequestVoteArgs::_internal_candidatedid() const {
  return candidatedid_;
}
inline int32_t RequestVoteArgs::candidatedid() const {
  // @@protoc_insertion_point(field_get:RequestVoteArgs.candidatedID)
  return _internal_candidatedid();
}
inline void RequestVoteArgs::_internal_set_candidatedid(int32_t value) {
  
  candidatedid_ = value;
}
inline void RequestVoteArgs::set_candidatedid(int32_t value) {
  _internal_set_candidatedid(value);
